    ...
    <View>
      <ScrollView>
        ...
        <View style={{ margin: 10 }}>
          <Title>Who May Use the Services</Title>
          <Paragraph>
            You may use the Services only if you agree to form a binding
            contract with Krishaki (A product of KPI Organization LLP) and are
            not a person barred from receiving services under the laws of the
            applicable jurisdiction. In any case, you must be at least 13 years
            old, or in the case of Periscope 16 years old, to use the Services.
        ...
        <View style={{ margin: 10 }}>
          <Title>Privacy</Title>
          <Paragraph>
            Our Privacy Policy (https://www.Krishaki.com/privacy) describes how
            ...
            information to the India, Ireland, and/or other countries for
            storage, processing and use by Krishaki and its affiliates.
          </Paragraph>
        </View>
        <View style={{ margin: 10 }}>
          <Title>Content on the Services</Title>
          <Paragraph>
            ...
            comfortable sharing with others. Any use or reliance on any Content
            or materials posted via the Services or obtained by you through the
            Services is at your own risk. We do not endorse, support, represent
            or guarantee the completeness, truthfulness, accuracy, or
            reliability of any Content or communications posted via the Services
            or endorse any opinions expressed via the Services. You understand
            that by using the Services, you may be exposed to Content that might
            ...
            Content. We reserve the right to remove Content that violates the
            User Agreement, including for example, copyright or trademark
            ...
            appealing violations can be found in our Help Center If you believe
            that your Content has been copied in a way that constitutes
            copyright infringement, please report this by visiting our Copyright
            reporting form (https:// help.Krishaki.com/forms/dmca) or contacting
            our designated copyright agent
          </Paragraph>
        </View>
        <View style={{ margin: 10 }}>
          <Title>Your Rights and Grant of Rights in the Content</Title>
          <Paragraph>
            ...
            considered part of the Content). By submitting, posting or
            ...
            all media or distribution methods now known or later developed (for
            clarity, these rights include, for example, curating, transforming,
            ...
            You agree that this license includes the right for Krishaki to
            ...
            distribution, RePost, promotion or publication of such Content on
            other media and services, subject to our terms and conditions for
            such Content use. Such additional uses by Krishaki, or other
            companies, organizations or individuals, is made with no
            ...
            Krishaki has an evolving set of rules for how ecosystem partners can
            ...
            different media. You represent and warrant that you have, or have
            ...
            You agree that such Content will not contain material subject to
            ...
            and to grant Krishaki the license described above.
          </Paragraph>
        </View>
        <View style={{ margin: 10 }}>
          <Title>Using the Services</Title>
          <Paragraph>
            Please review the Krishaki Rules and Policies, which are part of the
            ...
            applicable laws, rules and regulations. Our Services evolve
            ...
            generally. We also retain the right to create limits on use and
            storage at our sole discretion at any time. We may also remove or
            refuse to distribute any Content on the Services, limit distribution
            or visibility of any Content on the service, suspend or terminate
            users, and reclaim usernames without liability to you. Krishaki may
            offer certain services or features for a fee; by paying for or using
            one of these services, you agree to any additional terms applicable
            to that service. In consideration for Krishaki granting you access
            to and use of the Services, you agree that Krishaki and its
            third-party providers and partners may place advertising on the
            Services or in connection with the display of Content or information
            from the Services whether submitted by you or others. You also agree
            not to misuse our Services, for example, by interfering with them or
            ...
            while accessing or using the Services: (i) access, tamper with, or
            use non-public areas of the Services, Krishaki’s computer systems,
            or the technical delivery systems of Krishaki’s providers; (ii)
            ...
            available, published interfaces that are provided by Krishaki (and
            only pursuant to the applicable terms and conditions), unless you
            have been specifically allowed to do so in a separate agreement with
            Krishaki (NOTE: crawling the Services is permissible if done in
            accordance with the provisions of the robots.txt file, however,
            scraping the Services without the prior consent of Krishaki is
            ...
            sourceidentifying information; or (v) interfere with, or disrupt,
            ...
            rights, property or safety of Krishaki, its users and the public.
            Krishaki does not disclose personally identifying information to
            third parties except in accordance with our Privacy Policy.If you
            use advertising features of the Services, you must agree to our
            Krishaki Master Services Agreement (https://ads.Krishaki.com/terms).
          </Paragraph>
        </View>
        <View style={{ margin: 10 }}>
          ...
          <Paragraph>
            ...
            with the above. You can control most communications from the
            ...
            and you may not be able to opt-out from receiving them. If you added
            your phone number to your account and you later change or deactivate
            that phone number, you must update your account information to help
            prevent us from communicating with anyone who acquires your old
            number.
          </Paragraph>
        </View>
        <View style={{ margin: 10 }}>
          <Title>Your License to Use the Services</Title>
          <Paragraph>
            Krishaki gives you a personal, worldwide, royalty-free,
            non-assignable and nonexclusive license to use the software provided
            ...
            provided by Krishaki, in the manner permitted by these Terms. The
            Services are protected by copyright, trademark, and other laws of
            both the India and other countries. Nothing in the Terms gives you a
            right to use the Krishaki name or any of the Krishaki trademarks,
            ...
            the exclusive property of Krishaki and its licensors. Any feedback,
            comments, or suggestions you may provide regarding Krishaki, or the
        ...
        <View style={{ margin: 10 }}>
          <Title>Ending These Terms</Title>
          <Paragraph>
            You may end your legal agreement with Krishaki at any time by
            deactivating your accounts and discontinuing your use of the
            Services.We may suspend or terminate your account or cease providing
            you with all or part of the Services at any time for any or no
            reason, including, but not limited to, if we reasonably believe: (i)
            you have violated these Terms or the Krishaki Rules and Policies
            (ii) you create risk or possible legal exposure for us; (iii) your
            account should be removed due to unlawful conduct, (iv) your account
            should be removed due to prolonged inactivity; or (v) our provision
            of the Services to you is no longer commercially viable. We will
            make reasonable efforts to notify you by the email address
            associated with your account or the next time you attempt to access
            your account, depending on the circumstances. In all such cases, the
        ...
        <View style={{ margin: 10 }}>
          <Title>Disclaimers and Limitations of Liability</Title>
          <Title>The Services are Available “AS-IS”</Title>
          <Paragraph>
            ...
            you on an “AS IS” and “AS AVAILABLE” basis. The “Krishaki Entities”
            refers to Krishaki, its parents, affiliates, related companies,
            ...
            permitted under applicable law, THE KRISHAKI ENTITIES DISCLAIM ALL
            WARRANTIES AND CONDITIONS, WHETHER EXPRESS OR IMPLIED, OF
            MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR
            NON-INFRINGEMENT. The Krishaki Entities make no warranty or
            ...
            information, whether oral or written, obtained from the Krishaki
        ...
        <View style={{ margin: 10 }}>
          ...
          <Paragraph>
            TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE KRISHAKI
            ...
            YOUR TRANSMISSIONS OR CONTENT. IN NO EVENT SHALL THE AGGREGATE
            LIABILITY OF THE KRISHAKI ENTITIES EXCEED THE GREATER OF ONE HUNDRED
            U.S. DOLLARS (U.S. $100.00) OR THE AMOUNT YOU PAID KRISHAKI, IF ANY,
            IN THE PAST SIX MONTHS FOR THE SERVICES GIVING RISE TO THE CLAIM.
            THE LIMITATIONS OF THIS SUBSECTION SHALL APPLY TO ANY THEORY OF
            LIABILITY, WHETHER BASED ON WARRANTY, CONTRACT, STATUTE, TORT
            (INCLUDING NEGLIGENCE) OR OTHERWISE, AND WHETHER OR NOT THE KRISHAKI
        ...
        <View style={{ margin: 10 }}>
          ...
          <Paragraph>
            ...
            always be at Krishaki.com/tos, will govern our relationship with
            you. We will try to notify you of material revisions, for example
            ...
            revised Terms. The laws of the State of Uttar Pradesh, excluding its
            choice of law provisions, will govern these Terms and any dispute
            that arises between you and Krishaki. A disputes related to these
            Terms or the Services will be brought solely in the federal or state
            courts located in Ghaziabad, Uttar Pradesh, India, and you consent
            to personal jurisdiction and waive any objection as to inconvenient
            forum. In the event that any provision of these Terms is held to be
            ...
            Krishaki’s failure to enforce any right or provision of these Terms
            will not be deemed a waiver of such right or provision. These Terms
            are an agreement between you and KPI Organization LLP. If you have
